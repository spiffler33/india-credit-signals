...
This file is referenced in the project's CLAUDE.md via `@.claude/OUTPUT_STYLE.md`. Claude Code reads it automatically at session start. No manual activation needed.

If Claude Code stops following these rules mid-session, paste this reminder:
```
Follow @.claude/OUTPUT_STYLE.md — every output teaches. Show "Why This", concept cards, decision logs.
```
